        ...
        <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 transition-colors">
            ...
            <main className="flex-1 px-4 sm:px-6 lg:px-8 py-8 max-w-6xl mx-auto w-full">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <button onClick={() => navigate(-1)} className="text-slate-500 hover:text-blue-600 mb-2 flex items-center gap-1 transition-colors">
                            ← Back
                        </button>
                    ...
                    >
                        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                            ...
                            <div className="flex gap-4">
                                ...
                                >
                                    <span className="text-3xl font-bold text-green-600 dark:text-green-400 group-hover:scale-110 transition-transform">
                                ...
                                >
                                    ...
                                    <span className="text-xs text-blue-600 dark:text-blue-400 uppercase tracking-widest font-semibold mt-1">
                                        In OD
                                    </span>
                                </button>
                            </div>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-100 dark:border-slate-800 pb-6">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button
                                        ...
                                        className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 px-5 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2"
                                    >
                                        <span>📜</span> History
                                    </button>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-5 border border-slate-100 dark:border-slate-800/50">
                                    <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-3">Placement</h3>
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className={`h-3 w-3 rounded-full ${selectedItem.placement?.status === 'PLACED' ? 'bg-green-500' :
                                            selectedItem.placement?.status === 'NIP' ? 'bg-amber-500' : 'bg-slate-400'
                                            }`} />
                                ...
                                {/* 2. OD Stats */}
                                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-5 border border-slate-100 dark:border-slate-800/50">
                                    <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-3">OD Limits</h3>
                                ...
                                {/* 3. Mentor Info */}
                                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-5 border border-slate-100 dark:border-slate-800/50">
                                    <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-3">Assigned Mentor</h3>
                                    {selectedItem.mentor ? (
                                        <>
