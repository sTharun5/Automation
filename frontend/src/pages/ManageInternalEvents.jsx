                            ...
                            <div key={event.id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm flex flex-col hover:border-indigo-500/30 transition-colors">
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-auto">
                                    <button
                                        ...
                                        aria-label={`Project live QR attendance code for ${event.name}`}
                                        className="col-span-2 py-3 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-xs font-black uppercase tracking-widest rounded-xl hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-500 dark:hover:text-white transition-all flex items-center justify-center gap-2 border border-indigo-100/50 dark:border-indigo-500/20"
                                    >
                                        <MonitorPlay className="w-5 h-5" aria-hidden="true" /> Project Attendance QR
                                    </button>
                                    <button
                                        onClick={() => fetchAttendance(event)}
                                        disabled={isFetchingAttendance}
                                        aria-label={`View attendance log for ${event.name}`}
                                        className="py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-[10px] font-bold uppercase tracking-wider rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors flex items-center justify-center gap-1 border border-slate-200 dark:border-slate-700"
                                    ...
                                    <button
                                        ...
                                        aria-label={`View registered student roster for ${event.name}`}
                                        className="py-2.5 bg-purple-50 dark:bg-purple-500/10 text-purple-600 dark:text-purple-400 text-[10px] font-bold uppercase tracking-wider rounded-xl hover:bg-purple-600 hover:text-white dark:hover:bg-purple-500 dark:hover:text-white transition-colors flex items-center justify-center gap-1 border border-purple-100 dark:border-purple-500/20"
                                    ...
                                    <button
                                        ...
                                        aria-label={`Edit ${event.name} configuration`}
                                        className="py-2.5 bg-sky-50 dark:bg-sky-500/10 text-sky-600 dark:text-sky-400 text-[10px] font-bold uppercase tracking-wider rounded-xl hover:bg-sky-600 hover:text-white dark:hover:bg-sky-500 dark:hover:text-white transition-all flex items-center justify-center gap-2 border border-sky-100 dark:border-sky-500/20"
                                        title="Edit Event"
                                    >
                                    ...
                                    <button
                                        ...
                                        aria-label={`Permanently delete ${event.name}`}
                                        className="py-2.5 bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 text-[10px] font-bold uppercase tracking-wider rounded-xl hover:bg-red-600 hover:text-white dark:hover:bg-red-500 dark:hover:text-white transition-colors flex items-center justify-center gap-2 border border-red-100 dark:border-red-500/20"
                                        title="Delete Event"
                                    >
                                    ...
                                    <button
                                        ...
                                        aria-label={`View detailed administrative audit logs for ${event.name}`}
                                    ...
                                    >
                                        <ScrollText className="w-3.5 h-3.5" aria-hidden="true" /> Event Audit Logs
                                    </button>
                                </div>
                            </div>
                        ))
